"""Builds and saves an SVD index for StudyBuddy LeetCode problems.

Runs *after* leetcode_tfidf_index.py — reads the saved TF-IDF matrix and decomposes it.
Produces two artifacts:
  - leetcode_docs_compressed.pkl   : document vectors in SVD space (num_docs × k)
  - leetcode_words_compressed.pkl  : word vectors in SVD space (vocab_size × k)
...
DEFAULT_DOCS_PATH = PROJECT_ROOT / "processed" / "leetcode_docs_compressed.pkl"
DEFAULT_WORDS_PATH = PROJECT_ROOT / "processed" / "leetcode_words_compressed.pkl"

# Number of latent dimensions to keep.
# LeetCode dataset has ~3000 docs — 300 is a solid tradeoff between
# semantic coverage and memory/speed.
SVD_K = 300
...
def main() -> None:
    """CLI entrypoint for building the LeetCode SVD index."""
    ...
    print(
        f"Saved LeetCode SVD artifacts: "
